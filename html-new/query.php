...
include 'header.php';
?>
    <link rel="stylesheet" href="/jg/css-new/query.css">
    <div id="app"></div>
            ...
            try {
                ...
                if (!coreScriptsLoaded) {
                    ...
                    await Promise.all([
                        ...
                        loadScript(`/jg/js/query-utils.js?v=${version}`)
                    ]);
                ...
                // 加载查询分析页面脚本
                await loadScript(`/jg/js-pages/query.js?v=${version}`);
                ...
                const QueryPage = window.QueryPage || function() { return { init: () => Promise.resolve() }; };
                const page = new QueryPage({
